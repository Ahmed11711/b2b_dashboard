...
export const bagItemsFields = [
  ...
  { key: "desc", label: "Desc", type: "text", cell_type: "text", required: 1, placeholder: "Enter Desc", searchable: true, filterable: false, sortable: false, table_show: false, form_show: true, options: null },
  ...
  { key: "text", label: "Whose", type: "text", cell_type: "text", required: 0, placeholder: "Enter Whose", searchable: true, filterable: false, sortable: false, table_show: false, form_show: true, options: null },
  { key: "what_will_you_get", label: "What Will You Get", type: "text", cell_type: "text", required: 0, placeholder: "Enter What Will You Get", searchable: true, filterable: false, sortable: false, table_show: false, form_show: true, options: null },
